        ...
        <div class="p-6 lg:p-8 max-w-[1400px] w-full mx-auto space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="flex items-center gap-3 text-sm text-slate-500">
                    <a href="/Sistema%20de%20Faturacao/faturas.php" class="hover:text-blue-600 transition-colors">Faturas</a>
                    <span class="material-symbols-outlined text-[14px]">chevron_right</span>
                    <span class="font-semibold text-slate-900 font-mono"><?= htmlspecialchars($invoice['invoice_number']) ?></span>
                </div>
                <div class="flex items-center gap-2">
                    <a href="/Sistema%20de%20Faturacao/faturas.php?action=print&id=<?= $invoice['id'] ?>" target="_blank"
